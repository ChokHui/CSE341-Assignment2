...
<head>
    ...
    <meta http-equiv="refresh" content="5;url=AdminTimeline.php?reportNo=<?php echo $_GET['reportNo'];?>">
    <link rel="stylesheet" type="text/css" href="./styles/modern-normalize.css">
    <link rel="stylesheet" type="text/css" href="./styles/style.css">
    <link rel="stylesheet" type="text/css" href="./styles/AdminUpdatedStatusComponents/message.css">
    <link rel="stylesheet" type="text/css" href="./styles/utils.css">
    <title>Tenant Feedback Form - Admin Updated Status</title>
</head>
<body>
    <section class="message container">
        ...
        if (isset($_POST['Submit'])) {
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                // Escape and retrieve the updated status input
        ...
        function countdown() {
            ...
            var countdownInterval = setInterval(function () {
                ...
                if (count < 0) {
                    ...
                    window.location.href = "AdminTimeline.php?reportNo=<?php echo $reportNo; ?>";
                }
            }, 1000);
        }
