...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./styles/AdminUserComponents/hero.css">
    <link rel="stylesheet" type="text/css" href="./styles/AdminUserComponents/table.css">
    <link rel="stylesheet" type="text/css" href="./styles/utils.css">
    <title>Tenant Feedback Form - Admin List</title>
</head>
<body>
    <header>
      <?php
    ...
    <main>
        <section class="hero container">
            <h1 class="hero__title" >User List</h1>
        </section>
        <section class="hero container">
            <button class="table__btn btn" type="button" onclick="location.href='AdminAddUser.php';" id="delete">Add User</button>
        </section>
        <section class="table container">
            ...
            <tbody>
                ...
                <td>
                    <a href="deleteAdminData.php?id=<?php echo $row["id"] ?>">
    ...
    <script type="module">
      import addCloseListener from './src/utils/showToast.js';
      addCloseListener();
    </script>
</body>
</html>
